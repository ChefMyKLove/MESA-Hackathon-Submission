...
console.log(`\n${'═'.repeat(60)}`)
console.log(`NEW ORCHESTRATOR ADDRESS: ${newAddress}`)
console.log(`FUNDED WITH: ${FUND_AMOUNT.toLocaleString()} sats (0.5 BSV)`)
console.log(`${'═'.repeat(60)}`)
console.log(`\nNext steps:`)
console.log(`  1. Wait ~30s for tx to propagate`)
console.log(`  2. git add .env.orchestrator && git push  (if Railway reads from repo)`)
console.log(`     OR redeploy Railway with new env var AGENT_KEY=${newKeyHex.slice(0,16)}...`)
